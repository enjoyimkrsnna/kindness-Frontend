async function createPost() {
    ...
    console.log(jwttoken);
        ...
        const response = await fetch('https://kindnesskettle.projects.bbdgrad.com/api/fetchAllDonationPosts',{   
            method: 'GET',
            headers: {
        ...
        const LiketResponse = await fetch(`https://kindnesskettle.projects.bbdgrad.com/api/kindnessKettle/like/get?postId=${postRespone.donationPost.postId}`,
        {   
            method: 'GET',
            headers: {
    ...
    //         }
    //     ]
        const commentData = await fetch(`https://kindnesskettle.projects.bbdgrad.com/api/getComment/${postRespone.donationPost.postId}`,
        {   
            method: 'GET',
            headers: {
                'Authorization': `Bearer ${jwttoken}` 
    ...
    `;
        ...
        likeButton.addEventListener('click', async function() {
            ...
            await fetch(`https://kindnesskettle.projects.bbdgrad.com/api/kindnessKettle/like/${isLiked ? 'add' : 'delete'}?userId=${user.user.userId}&postId=${postRespone.donationPost.postId}`, {
                method: 'POST',
                headers: {
                    'Authorization': `Bearer ${jwttoken}`
                }
